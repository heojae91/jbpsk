...
* <p>
     * Wikipedia reference:
     * <a href="http://en.wikipedia.org/wiki/Prototype_filter">Prototype
     * filter"</a>
     *     
* @param filterCharacteristicsType The filter characteristics type. The
     * following filters are implemented: Butterworth, Chebyshev (type 1),
     * Bessel.
     * @param filterOrder The filter order.
     * @param ripple Passband ripple in dB. Must be negative. Only used for
     * Chebyshev filter, ignored for other filters.
     * @return The s-plane poles.
     */
    ...
    /**
     * Transforms the s-plane poles of the prototype filter into the s-plane
     * poles and zeros for a filter with the specified pass type and cutoff
     * frequencies.
     *     
* <p>
     * The cutoff frequencies are specified relative to the sampling rate and
     * must be between 0 and 0.5.
     *     
* @param poles The s-plane poles of the prototype LP filter.
     * @param filterPassType The filter pass type (Lowpass, highpass, bandpass,
     * bandstop).
     * @param fcf1 The relative filter cutoff frequency for lowpass/highpass,
     * lower cutoff frequency for bandpass/bandstop.
     * @param fcf2 Ignored for lowpass/highpass, the relative upper cutoff
     * frequency for bandpass/bandstop,
     * @param preWarp <code>true</code> to enable prewarping of the cutoff
     * frequencies (for a later bilinear transform from s-plane to z-plane),
     * <code>false</code> to skip prewarping (for a later matched Z-transform).
     * @return The s-plane poles and zeros for the specific filter.
     */
...
* <p>
     ...
     * <a href="http://en.wikipedia.org/wiki/Bilinear_transform">Bilinear
     * transform"</a>
     * <a href="http://en.wikipedia.org/wiki/Matched_Z-transform_method">Matched
     * Z-transform method</a>
     *     
* @param sPlane Poles and zeros of the s-plane.
     * @param SToZMappingMethod The mapping method to be used.
     * @return Poles and zeros of the z-plane.
     */
    ...
    /**
     * Given the z-plane poles and zeros, compute the rational fraction (the top
     * and bottom polynomial coefficients) of the filter transfer function in Z.
     *     
* @param zPlane The poles and zeros of the z-plane.
     * @return Coefficients of the rational fraction of the Z transfer function.
     */
     ...
     *     
* @param tf Coefficients of the filter transfer function in Z.
     * @param filterPassType The filter pass type (Lowpass, highpass, bandpass,
     * bandstop).
     * @param fcf1 The relative lower cutoff frequency for bandpass. Ignored for
     * other filter pass types.
     * @param fcf2 the relative upper cutoff frequency for bandpass. Ignored for
     * other filter pass types.
     * @return For lowpass: The gain at DC. For highpass: The gain at
     * samplingRate/2. For bandpass: The gain at the center frequency. For
     * bandstop: sqrt( [gain at DC] * [gain at samplingRate/2] )
     */
    ...
    /**
     * Returns the IIR filter coefficients for a transfer function. Normalizes
     * the coefficients so that a[0] is 1.
     *     
* @param tf Coefficients of the filter transfer function in Z.
     * @return The IIR filter coefficients (A and B coefficients).
     */
...
* <p>
     * The cutoff frequencies are specified relative to the sampling rate and
     * must be between 0 and 0.5.<br>
     * The following formula can be used to calculate the relative frequency
     * values:
...
* @param filterPassType The filter pass type (Lowpass, highpass, bandpass,
     ...
     * Chebyshev filter, ignored for other filters.
     * @param fcf1 The relative filter cutoff frequency for lowpass/highpass,
     * lower cutoff frequency for bandpass/bandstop. This value is relative to
     * the sampling rate (see above for more details).
     * @param fcf2 Ignored for lowpass/highpass, the relative upper cutoff
     * frequency for bandpass/bandstop, This value is relative to the sampling
     * rate (see above for more details).
     * @return The IIR filter coefficients.
     */
